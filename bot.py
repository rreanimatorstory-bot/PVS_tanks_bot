...
async def members(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for i, player in enumerate(members, start=1):
        ...
        text += (
            ...
            f"⚔️ {player['battles']} | 🏆 {player['winrate']}% | 💥 {player['avg_damage']}\n\n"
        )  
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "stats":
        ...
        await query.message.reply_text(
            "ℹ️ Информация о BlitzClanBot\n\n"

            "🤖 Что умеет бот:\n"
            "• показывает статистику игроков WoT Blitz\n"
            "• ведёт историю активности игроков\n"
            "• показывает состав клана\n"
            "• формирует отчёты клана\n"
            "• выводит ТОП игроков\n\n"

            "📌 Команды:\n"
            "/stats — статистика игрока\n"
            "/history — активность игрока\n"
            "/members — состав привязанного клана\n"
            "/top — ТОП игроков клана\n"
            "/report — отчёт клана\n"
            "/myclan — информация о привязанном клане\n"
            "/setclan — привязка клана (только для администраторов чата)\n\n"

            "🏰 Привязка клана:\n"
            "Команда /setclan доступна только администраторам группы.\n"
            "Администратор может привязать клан через кнопку «🏰 Привязать клан» "
            "или командой /setclan.\n\n"

            "🛠️ Управление операциями:\n\n"
            "Если вы начали действие, требующее ввода данных:\n"
            "• 📊 статистика игрока\n"
            "• 📈 история игрока\n"
            "• 🏰 привязка клана\n\n"
            "но передумали или хотите отменить текущую операцию — используйте команду:\n\n"
            "/cancel\n\n"
            "Команду можно ввести вручную или выбрать из списка команд:\n"
            "нажмите \"/\" в поле ввода сообщения и выберите нужную команду из меню.\n\n"


            "💻 Технологии:\n"
            "Python + Telegram Bot API + Wargaming API\n\n"
